...
if __name__ == "__main__":
    ...
    bathroom_light = Light('Luz do quarto', 'Banheiro')
    ...
    remote.button_add_command('four_button', bedroom_light_red)
    ...
    remote.button_pressed('four_button')
    remote.button_undo('four_button')
