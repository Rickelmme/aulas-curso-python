...
if __name__ == "__main__":
    ...
    print('20%', order.total, order.total_with_discount)

    order = Order(1000, fifty_percent)
    print('50%', order.total, order.total_with_discount)

    order = Order(1000, no_discount)
    print('0%', order.total, order.total_with_discount)

    order = Order(1000, five_percent)
    print('5%', order.total, order.total_with_discount)
