...
class TestPessoa(unittest.TestCase):
    def setUp(self):
        self.p1 = Pessoa('Rick', 'Barreto')
        self.p2 = Pessoa('Zeca', 'Cruz')

    def test_pessoa_attr_nome_tem_valor_correto(self):
        self.assertEqual(self.p1.nome, 'Rick')
        self.assertEqual(self.p2.nome, 'Zeca')
    ...
    def test_pessoa_attr_sobrenome_tem_valor_correto(self):
        self.assertEqual(self.p1.sobrenome, 'Barreto')
        self.assertEqual(self.p2.sobrenome, 'Cruz')
